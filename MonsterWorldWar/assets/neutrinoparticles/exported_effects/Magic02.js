// 26dd835b-b80d-4187-b001-86473820e34e
...
(function (root, factory) {
    if (typeof exports === 'object' && typeof module !== 'undefined') {
        ...
        define(['exports'], function (exports) {
            (root.NeutrinoEffect = exports)['Magic02'] = factory();
        });
    } else {
        var namespace = (root.NeutrinoEffect || (root.NeutrinoEffect = {}));
        namespace.__last__ = namespace['Magic02'] = factory();
    }
}(typeof self !== 'undefined' ? self : this, function () {

function Magic02(ctx) {
	var Db = this;
	...
	function Emitter_DefaultEmitter() {
		...
		var _, _i0, _s0 = [], _2, _3 = [], _4 = [], _6 = [], _11, _13, _14 = [], _14i0, _14s0 = [], _14i1, _14s1 = [], _14i2, _14s2 = [], _16, _17=[], _17fs=[], _17vs=[], _17rw=[], _17rwn=[], _17rwl, _17v=[], _17p=[], _17dtl, _17dtp, _17df, _17fsd=[], _18, _19, _20, _20i0, _20s0 = [], _21;
		...
		this.ud = function(Bd) {
			Bd._ = [
				[
					[0,228.316,228.316],
					[228.316,554.599,554.599],
					[554.599,425.135,425.135],
					[425.135,-78.6544,-78.6544]
				]
			];
			Bd.dd();
			Bd._14 = [
			...
			Bd._20 = [
				[
					[0,1,1],
					[1,1,1],
					[1,0.989784,0.962032,0.920243,0.867111,0.804789,0.735067,0.659483,0.579406,0.496103,0.410788,0.32468,0.239048,0.15528,0.0749618,0,0]
				]
			];
			Bd.jd = 200;
			Bd.Vc = 0;
		...
		this.Pb = function(Qb, Bd, vd) {
			_i0=(Bd.Ld.Rb<0?0:(Bd.Ld.Rb>1.54334?(0+((Bd.Ld.Rb-0)%1.54334)):Bd.Ld.Rb));
			_i0<0.713108?_i0<0?ctx.V(_s0,0,(_i0-0)*inf):ctx.V(_s0,1,(_i0-0)*1.40231):_i0<1.54334?ctx.V(_s0,2,(_i0-0.713108)*1.20448):ctx.V(_s0,3,(_i0-1.54334)*inf);
		...
		this.fd = function(Bd, Xb) {
			Xb._1 = 0.0;
			_2 = 100 + Bd.Ld.rand() * (150 - 100);
			ctx.randv2gen(_3, _2, Bd.Ld.rand);
			...
			Xb._10 = [];
			ctx.T(Xb._10, Xb._5);
			_11 = 10 + Bd.Ld.rand() * (30 - 10);
			Xb._12 = _11;
			_13 = 0 + Bd.Ld.rand() * (1 - 0);
			_14i0=(_13<0?0:(_13>1?1:_13));
			ctx.V(_14s0,0,(_14i0-0)*1);
			_14i1=(_13<0?0:(_13>1?1:_13));
			ctx.V(_14s1,0,(_14i1-0)*1);
			_14i2=(_13<0?0:(_13>1?1:_13));
			ctx.V(_14s2,0,(_14i2-0)*1);
			ctx.W(_14, Db.nb(Bd._14[0][_14s0[0]],_14s0[1]),Db.nb(Bd._14[1][_14s1[0]],_14s1[1]),Db.nb(Bd._14[2][_14s2[0]],_14s2[1]));
			Xb._15 = [];
			ctx.T(Xb._15, _14);
			ctx.T(Xb.Ab, Xb._5);
		}
		...
		this.qc = function(Qb, Bd, Xb) {
			Xb._1 += Qb;
			_16 = ctx.v(ctx.h(Xb._9, Xb._10), 2);
			ctx.T(_17fs, _16);
			ctx.T(_17vs, [0,0,0]);
			ctx.u(_17v, _17fs, Qb);
			ctx.c(_17v, _17v, Xb._7);
			ctx.u(_17p, _17v, Qb);
			ctx.c(_17p, _17p, Xb._5);
			ctx.T(Xb._5, _17p);
			ctx.T(Xb._7, _17v);
			ctx.T(Xb.Ab, Xb._5);
			_18 = 1;
			...
			_20i0<0.4?_20i0<0.1?ctx.V(_20s0,0,(_20i0-0)*10):ctx.V(_20s0,1,(_20i0-0.1)*3.33333):ctx.V(_20s0,2,(_20i0-0.4)*25);
