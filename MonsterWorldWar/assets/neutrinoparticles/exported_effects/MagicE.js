// fa8ec124-38a3-4c3b-bed5-78be2cd2e5cc
...
(function (root, factory) {
    if (typeof exports === 'object' && typeof module !== 'undefined') {
        ...
        define(['exports'], function (exports) {
            (root.NeutrinoEffect = exports)['MagicE'] = factory();
        });
    } else {
        var namespace = (root.NeutrinoEffect || (root.NeutrinoEffect = {}));
        namespace.__last__ = namespace['MagicE'] = factory();
    }
...
function MagicE(ctx) {
	...
	function Emitter_DefaultEmitter() {
		...
		var _1 = [], _3, _5, _7, _8 = [], _8i0, _8s0 = [], _8i1, _8s1 = [], _8i2, _8s2 = [], _10, _12, _11, _13, _14, _14i0, _14s0 = [], _15, _16, _16i0, _16s0 = [];
		...
		this.ud = function(Bd) {
			...
			Bd._8 = [
				[
					[0.42926,0.494951,0.494951],
					[0.532859,0.313887,0.313887]
				],
				[
					[1,2,2],
					[1.52203,1.78103,1.78103]
				],
				[
					[1,1,1],
					[1.30656,1.47447,1.47447]
				]
			];
			Bd._14 = [
				[
					[0,0.021076,0.0476271,0.0797259,0.117482,0.161046,0.210616,0.266445,0.328851,0.398229,0.475073,0.560002,0.653796,0.757454,0.872276,1,1]
				]
			];
			Bd._16 = [
				[
		...
		this.fd = function(Bd, Xb) {
			...
			_3 = 0 + Bd.Ld.rand() * (360 - 0);
			Xb._4 = _3;
			_5 = 0 + Bd.Ld.rand() * (90 - 0);
			Xb._6 = _5;
			_7 = 0 + Bd.Ld.rand() * (1 - 0);
			_8i0=(_7<-0.540501?-0.540501:(_7>0.750538?0.750538:_7));
			_8i0<-0.326164?ctx.V(_8s0,0,(_8i0- -0.540501)*4.66556):ctx.V(_8s0,1,(_8i0- -0.326164)*0.928762);
			_8i1=(_7<-0.670429?-0.670429:(_7>0.5?0.5:_7));
			_8i1<-0.170429?ctx.V(_8s1,0,(_8i1- -0.670429)*2):ctx.V(_8s1,1,(_8i1- -0.170429)*1.49158);
			_8i2=(_7<0.4?0.4:(_7>1.2?1.2:_7));
			_8i2<0.555914?ctx.V(_8s2,0,(_8i2-0.4)*6.4138):ctx.V(_8s2,1,(_8i2-0.555914)*1.55259);
