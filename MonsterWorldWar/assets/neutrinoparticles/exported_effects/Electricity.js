// dd373488-ba30-478a-b18d-2449b2d971ef
...
(function (root, factory) {
    if (typeof exports === 'object' && typeof module !== 'undefined') {
        ...
        define(['exports'], function (exports) {
            (root.NeutrinoEffect = exports)['Electricity'] = factory();
        });
    } else {
        var namespace = (root.NeutrinoEffect || (root.NeutrinoEffect = {}));
        namespace.__last__ = namespace['Electricity'] = factory();
    }
...
function Electricity(ctx) {
	...
	this.textures = ['electricity2x2.png'];
	this.materials = [1];
	...
	function Emitter_DefaultEmitter() {
		...
		var _1 = [], _3, _5 = [], _7, _9, _11=[], _12, _14 = [], _13, _15, _16 = [], _16i0, _16s0 = [], _16i1, _16s1 = [], _17;
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			_16i0<0.5?_16i0<0.251188?ctx.V(_16s0,0,(_16i0-0)*3.98108):ctx.V(_16s0,1,(_16i0-0.251188)*4.0191):_16i0<0.749401?ctx.V(_16s0,2,(_16i0-0.5)*4.00961):ctx.V(_16s0,3,(_16i0-0.749401)*3.99044);
			_16i1=(_15<0?0:(_15>1?1:_15));
			ctx.V(_16s1,0,(_16i1-0)*1);
			ctx.V(_16, Db.nb(Bd._16[0][_16s0[0]],_16s0[1]),Db.nb(Bd._16[1][_16s1[0]],_16s1[1]));
			_17 = ctx.j(_14, _16);
			ctx.S(Xb.Pd,[0.5,0.55]);
			Xb.Md = Xb._4;
			ctx.S(Xb.Nd,_17);
			ctx.T(Xb.gf,[1,1,1]);
			Xb.Od = 1;
			Xb.Qc = (Xb._8 < 0) ? 0 : ((Xb._8 >= 4) ? 3 : Xb._8);
		}
