// e08c1e1f-d5a9-47eb-b6de-69aaa1f254d0
...
(function (root, factory) {
    if (typeof exports === 'object' && typeof module !== 'undefined') {
        ...
        define(['exports'], function (exports) {
            (root.NeutrinoEffect = exports)['Magic01'] = factory();
        });
    } else {
        var namespace = (root.NeutrinoEffect || (root.NeutrinoEffect = {}));
        namespace.__last__ = namespace['Magic01'] = factory();
    }
}(typeof self !== 'undefined' ? self : this, function () {

function Magic01(ctx) {
	var Db = this;
	...
	function Emitter_DefaultEmitter() {
		...
		this.ud = function(Bd) {
			...
			Bd._8 = [
				[
					[0.640933,0.640933,0.640933],
					[1,1,1]
				],
				[
					[0.264767,0.264767,0.264767],
					[0.545596,0.545596,0.545596]
				],
				[
					[0.740933,0.746632,0.746632],
					[0.746632,0.740933,0.740933]
				]
			];
			Bd._14 = [
				[
		...
		this.fd = function(Bd, Xb) {
			...
			Xb._6 = _5;
			_7 = 0 + Bd.Ld.rand() * (1 - 0);
			_8i0=(_7<0?0:(_7>1?1:_7));
			_8i0<0.5?ctx.V(_8s0,0,(_8i0-0)*2):ctx.V(_8s0,1,(_8i0-0.5)*2);
			_8i1=(_7<0?0:(_7>1?1:_7));
			_8i1<0.5?ctx.V(_8s1,0,(_8i1-0)*2):ctx.V(_8s1,1,(_8i1-0.5)*2);
			_8i2=(_7<0?0:(_7>1?1:_7));
			_8i2<0.5?ctx.V(_8s2,0,(_8i2-0)*2):ctx.V(_8s2,1,(_8i2-0.5)*2);
