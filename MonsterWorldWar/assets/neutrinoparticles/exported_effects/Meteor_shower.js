// 10ae64de-0bc8-4d8e-9bf5-582bde9059c8
...
(function (root, factory) {
    if (typeof exports === 'object' && typeof module !== 'undefined') {
        ...
        define(['exports'], function (exports) {
            (root.NeutrinoEffect = exports)['Meteor_shower'] = factory();
        });
    } else {
        var namespace = (root.NeutrinoEffect || (root.NeutrinoEffect = {}));
        namespace.__last__ = namespace['Meteor_shower'] = factory();
    }
}(typeof self !== 'undefined' ? self : this, function () {

function Meteor_shower(ctx) {
	var Db = this;
	...
	this.textures = ['meteor_fire.png','meteor_smoke.png'];
	this.materials = [1,0];
	this.renderStyles = [{materialIndex:0,textureIndices:[0]},{materialIndex:1,textureIndices:[1]}];
	this.Xe = 20000;

	function Emitter_Tale_fire() {

		var _1 = [], _3 = [], _5, _7, _9=[], _9fs=[], _9vs=[], _9rw=[], _9rwn=[], _9rwl, _9v=[], _9p=[], _9dtl, _9dtp, _9df, _9fsd=[], _10, _12, _11, _13, _14, _14i0, _14s0 = [], _15, _16, _16i0, _16s0 = [];
		...
		this.ud = function(Bd) {
			...
			Bd._14 = [
				[
					[0.3,0.566901,0.667896,0.737929,0.791686,0.834859,0.870353,0.899881,0.924537,0.94506,0.961958,0.975579,0.986146,0.993771,0.998445,1,1],
					[1,0.995474,0.983417,0.964337,0.938746,0.907157,0.870088,0.828062,0.78161,0.731274,0.677606,0.621172,0.562555,0.502355,0.441196,0.379723,0.379723]
				]
			];
			Bd._16 = [
				[
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			_11 = 0.7;
			_13 = (Xb._ / _11);
			_14i0=(_13<0?0:(_13>1.2?1.2:_13));
			_14i0<0.2?ctx.V(_14s0,0,(_14i0-0)*75):ctx.V(_14s0,1,(_14i0-0.2)*15);
			_14 = Db.nb(Bd._14[0][_14s0[0]],_14s0[1]);
			_15 = (_12 * _14);
			_16i0=(_13<0?0:(_13>1?1:_13));
			_16i0<0.4?ctx.V(_16s0,0,(_16i0-0)*2.5):ctx.V(_16s0,1,(_16i0-0.4)*1.66667);
	...
	function Emitter_Tale_smoke() {

		var _1 = [], _3 = [], _5, _7, _9=[], _9fs=[], _9vs=[], _9rw=[], _9rwn=[], _9rwl, _9v=[], _9p=[], _9dtl, _9dtp, _9df, _9fsd=[], _10, _12, _11, _13, _14, _14i0, _14s0 = [], _15, _16, _16i0, _16s0 = [];
		this.pe = [{xe:0,Rc:1,Sc:1,renderStyleIndex:1}];
		this.name = "Tale_smoke";
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			_14 = Db.nb(Bd._14[0][_14s0[0]],_14s0[1]);
			_15 = (_12 * _14);
			_16i0=(_13<0.132286?0.132286:(_13>1?1:_13));
			_16i0<0.6?_16i0<0.4?ctx.V(_16s0,0,(_16i0-0.132286)*3.73533):ctx.V(_16s0,1,(_16i0-0.4)*5):ctx.V(_16s0,2,(_16i0-0.6)*2.5);
			_16 = Db.nb(Bd._16[0][_16s0[0]],_16s0[1]);
			ctx.S(Xb.Pd,[0.5,0.5]);
			Xb.Md = Xb._6;
			ctx.V(Xb.Nd,_15,_15);
	...
	function Emitter_Parent() {
		...
		var _1, _2 = [], _2i, _2s = [], _3 = [], _5, _6 = [], _6i, _6s = [], _7 = [], _10=[], _11;
		this.pe = [];
		this.name = "Parent";
		...
		this.ud = function(Bd) {
			Bd.dd();
			Bd._2 = [
				[[501.257,-78.077],[884.257,-81.077],[884.257,-81.077]],
				[[884.257,-81.077],[883.257,260.923],[883.257,260.923]]
			];
			Bd._6 = [
				[[-471.743,341.923],[-459.094,353.808],[-446.434,365.681],[-433.769,377.549],[-421.099,389.414],[-408.428,401.275],[-395.754,413.135],[-383.08,424.994],[-370.406,436.852],[-357.732,448.711],[-345.059,460.571],[-332.387,472.432],[-319.718,484.297],[-307.052,496.165],[-294.393,508.038],[-281.743,519.923],[-281.743,519.923]]
			];
			Bd.uc(new Emitter_Tale_fire(), { xc: 1, sd: false });
			Bd.uc(new Emitter_Tale_smoke(), { xc: 1, sd: false });
			Bd.jd = 100;
			Bd.Vc = 0;
		}
		...
		this.fd = function(Bd, Xb) {
			...
			_1 = 0 + Bd.Ld.rand() * (1 - 0);
			_2i = Db.kb(_1);
			_2i<0.528282?ctx.V(_2s,0,(_2i-0)*1.89293):ctx.V(_2s,1,(_2i-0.528282)*2.11991);
